...
```
Error: locator.click: Error: strict mode violation: locator('li.list-inline-item a.dropdown-toggle') resolved to 2 elements:
    1) <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">…</a> aka getByRole('link', { name: '$ Currency ' })
    2) <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">…</a> aka getByRole('link', { name: ' My Account ' })

Call log:
  - waiting for locator('li.list-inline-item a.dropdown-toggle')
...
```ts
  ...
  16 |     this.page = page;
  17 |     this.myAccountDropdown = this.page.locator(
  18 |       "li.list-inline-item a.dropdown-toggle",
  19 |     );
