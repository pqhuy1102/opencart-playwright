            ...
            - group "Your Personal Details" [ref=f1e84]:
              ...
              - generic [ref=f1e94]:
                ...
                - textbox "* E-Mail" [ref=f1e97]:
                  - /placeholder: E-Mail
                  - text: Bethel_Balistreri86@example.com
...
```ts
  ...
  29 | 
  30 |   // Verify message
  31 |   const actionResultPage = new ActionResultPage(page);
> 32 |   await expect(actionResultPage.isRegisterResultPageLoaded()).resolves.toBe(
     |                                                                        ^ Error: expect(received).resolves.toBe(expected) // Object.is equality
  33 |     true,
  34 |   );
  35 | });
