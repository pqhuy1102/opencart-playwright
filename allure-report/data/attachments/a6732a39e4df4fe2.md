...
```
Error: locator.click: Error: strict mode violation: locator('li.list-inline-item div.dropdown a.dropdown-toggle') resolved to 2 elements:
...
Call log:
  - waiting for locator('li.list-inline-item div.dropdown a.dropdown-toggle')
...
```ts
  ...
  18 |       "li.list-inline-item div.dropdown a.dropdown-toggle",
  19 |     );
